...
public class KategoriFragment extends android.support.v4.app.Fragment {
    ...
    private void dataCategories() {
        ...
        categoriesList.add(categories);
        categories = new Categories(1, "Kategori 1", "https://img.icons8.com/color/1600/reading.png", 20);
        categoriesList.add(categories);
        categories = new Categories(2, "Kategori 2", "https://img.icons8.com/color/1600/rubiks-cube.png", 20);
        categoriesList.add(categories);
        categories = new Categories(3, "Kategori 3", "https://img.icons8.com/color/1600/code.png", 20);
        categoriesList.add(categories);
        categories = new Categories(4, "Kategori 4", "https://img.icons8.com/color/1600/drafting-compass2.png", 20);
        categoriesList.add(categories);
        categories = new Categories(5, "Kategori 5", "https://img.icons8.com/color/1600/paint-palette.png", 20);
        categoriesList.add(categories);
        categories = new Categories(1, "Kategori 1", "https://img.icons8.com/color/1600/mars-planet.png", 20);
        categoriesList.add(categories);
        categories = new Categories(2, "Kategori 2", "https://img.icons8.com/color/1600/numerology-square.png", 20);
        categoriesList.add(categories);
        categories = new Categories(3, "Kategori 3", "https://img.icons8.com/color/1600/test-tube.png", 20);
        categoriesList.add(categories);
        categories = new Categories(4, "Kategori 4", "https://img.icons8.com/color/1600/calculator.png", 20);
        categoriesList.add(categories);
        categories = new Categories(5, "Kategori 5", "https://img.icons8.com/color/1600/sunbathe.png", 20);
        categoriesList.add(categories);
    }
